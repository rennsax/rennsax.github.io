...
The <span class="inline-card"><img src="/assets/img/2025-07/Erratic_Deck.webp" alt="Erratic Deck"/></span> Erratic Deck is erratic: Try the seed `XEQH7CP9`, you will get an incomprehensible deck:
...
$$N_2 = (26+9)^{8} = 3512479453921 \approx 3.51 \times 10^{12}.$$
...
$$p = 1 - \left(\frac{N1-52}{N_1}\right)^{N_2} \approx 2.31 \times 10^{-16}.$$

If you have no idea how low this probability is, let me show you some statistics:
